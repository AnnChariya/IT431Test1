    ...
    <table width="1238" height="530" border="0">
        ...
        <tr>
            ...
            <td width="190" bgcolor="#FFFF66"><ul>
				...
				<li><a href="home.php">สวัสดีคาบท่านสมาชิก ชมรมคนรักโค้ดดดดดดดดดด ทุกคนนน สุดท้ายละะ</li>
				<li><a href="room.php">ห้องพัก&ราคา</li>
				<li><a herf="guest.php">สมุดเยี่ยมมากกก ดีจ้าาาา ครั้งสุดท้ายหรือเปล่านะ</li>
